...
#--------------------------------cachpage save link-----------------------------------------------
            ...
            rank = 1
           # value = general.xpath(source,'//div[@class="dpb-holder loaded svelte-1rtlpp7"]/a/@href',mode='set')
            value=general.xpath(source,'//div[@class="dpb-holder loaded svelte-rkii6s"]/a/@href',mode="set")
            ...
            if value:
                for eachval in value:
                    ...
                    if 'zalando' not in url.lower():
                        url = 'https://www.decathlon.fr' + url
